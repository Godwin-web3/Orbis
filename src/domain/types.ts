...
export type PreparedTransaction = TransactionRequest & { chainId: number; gas: bigint; gasPriceWei: bigint; simulationMode: string; policy: "PASS" | "REJECT" | "SKIP"; reasons: string[]; preparedAt: string; candidateId?: string; mintFunction?: string; abi?: unknown[]; nftContract?: Address; name?: string; estimatedValueNative?: number; floorNative?: number; recentMints?: number; valueScore?: number };
